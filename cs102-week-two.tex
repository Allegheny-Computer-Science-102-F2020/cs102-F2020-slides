...
\begin{frame}{Analyzing and Visualizing Temperature Values}
  ...
  \begin{figure}
    ...
    \begin{center}
      ...
      How would be visualized a sequence of temperature values?
      %
    \end{center}
    %
  \end{figure}
...
% Slide
%
\begin{frame}{Reviewing Variables Use in Python Programs}
  %
  \begin{itemize}
    %
    ...
    \item A function can manipulate a variable using operators
      ...
      \begin{itemize}
        ...
        \item The {\tt +=} symbol denotes addition and assignment
          %
        \item The {\tt \%} symbol denotes modular arithmetic
          %
      \end{itemize}
      %
      \vspace*{-.2in}
